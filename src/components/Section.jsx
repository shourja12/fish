  ...
  return (
    <section className="py-24 md:py-32">
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <h2 className="text-3xl md:text-4xl font-semibold text-center mb-16 text-gray-900 tracking-tight">
          {title}
        </h2>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-12">
          ...
          {data.map((item, i) => (
            <div
              key={i}
              className="group bg-white p-5 rounded-3xl border border-gray-200 shadow-sm hover:shadow-lg hover:-translate-y-2 transition-all duration-500"
            >
