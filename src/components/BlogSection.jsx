export default function BlogSection() {
  return (
    <section
      className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 bg-gradient-to-br from-blue-50 via-cyan-50 to-blue-100"
      data-aos="fade-up"
    >
      <div className="max-w-5xl mx-auto text-center">

        {/* Title */}
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-900 mb-4 sm:mb-6 md:mb-8 leading-tight">
          Discover the World of Aquatic Beauty
        </h1>

        {/* Subtitle */}
        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 mb-8 sm:mb-10 md:mb-12">
        ...
        {/* Content Blocks */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 sm:gap-6 md:gap-10 text-left">

          <div
            className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm hover:shadow-lg transition"
            data-aos="fade-right"
          >
            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3 text-blue-700">
          ...
          <div
            ...
            data-aos="fade-left"
          >
            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2 sm:mb-3 text-cyan-700">
              Marine Ecosystems
            </h2>
            <p className="text-xs sm:text-sm md:text-base text-gray-600 leading-relaxed">
